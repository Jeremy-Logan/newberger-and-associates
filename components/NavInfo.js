...
export const NavInfo = ({ toggle }) => {
	return (
		<motion.div className='relative w-screen z-40'>
			<motion.div
				className='pt-12 center absolute origin-bottom top-0 left-0 w-4/12 bg-[#8B8888] h-[60vh] mt-[40vh]'
				variants={variants}

				onClick={toggle}>
				<div className='lg:px-20 px-2 text-white text-right text-lg xl:text-2xl font-sans'>
