				...
				<main>
					...
					<div className='h-auto mx-[15vw] mb-48 font-bold font-serif'>
						...
						<div className='flex flex-col md:flex-row'>
							...
							<p className='ml-12 text-2xl text-[#414141] leading-relaxed font-sans font-normal w-screen md:w-2/3'>
								...
								relationship between the structure and the land
								it occupies, utilizing the unique
								characteristics offered by the site.
								<br />
								<br />
								Our 20+ years of coastal planning experience has
								put us in the unique position of knowing not
								only how to design for your coastal space, but
								also how to navigate the unique challenges
								coastal building can present. Our expertise is
								perfectly suited to guiding you through the
								process of negotiating permits, bluff erosion
								control, coastal garden planning.
							</p>
						</div>
					</div>
					<div></div>
