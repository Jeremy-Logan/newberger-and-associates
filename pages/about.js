						...
						<div className='flex flex-col md:flex-row'>
							<div className='relative w-screen md:w-1/3  '>
								<Image
									...
									objectFit='contain'
								/>
							</div><div className=' ml-12 w-screen md:w-2/3'>
							<h3 className='text-4xl mb-8'>Todd Newberger</h3>
							<p className=' text-xl text-[#414141] leading-relaxed font-sans font-normal '>
								...
								wide ranging functions. From residential to
								commercial, big sweeping mansions to intimate
								cottages, from high end tasting rooms to
								large-scale medical facilities: all of Todd's
								projects are as beautiful as they are
								functional. <br /> <br />He escapes it all by
								retreating to his vegetable garden by the sea,
								puttering and planning. Todd's love of the
								outdoors also calls him to the ocean. Here he
								can be found freediving in the cold Pacific
								waters, usually to catch his dinner.<br /> <br />{' '}
								Todd's deep passion for architecture joins with
								his love of nature to create wonderful, livable
								places and spaces for every project he tackles.{' '}
								<br /><br /> Todd is accredited by the California
								Architects Board, holds a California Landscape
								Contractors License, is a Certified Energy
								Analyst and a Leadership in Energy and
								Environmental Design Accredited Professional.
								His work has been featured on Home and Garden
