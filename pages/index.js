		...
		<div>
			...
			<main>
				<motion.div
					...
					<div className='absolute pt-24 pl-[10vw] w-[80vw] z-10 text-white'>
						...
						<motion.div
							...
							className='font-sans 2xl:text-5xl xl:text-4xl lg:text-4xl text-2xl md:ml-8 lg:w-6/12 leading-tight'>
				...
				<div className='md:h-96 mx-12 md:mx-[25vw] font-bold font-serif'>
					...
					<h3 className=' text-xl text-[#414141] leading-relaxed tracking-wide font-sans font-normal mb-12'>
